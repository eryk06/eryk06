...
<div align="center">
    ...
    <br>
    <br>
    <img src="https://skillicons.dev/icons?i=html,css,js,ts,nodejs,nestjs,react,redux,nextjs,materialui,tailwind,postgres,mongodb,redis,docker,kafka,rabbitmq,nginx,firebase,ansible,jenkins,postman,linux,vscode,git,github,githubactions,gitlab,vite,webpack,rollupjs,cloudflare&perline=8&theme=dark" alt="My Skills" />
</div>
